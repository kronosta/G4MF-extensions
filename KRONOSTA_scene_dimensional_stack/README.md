The KRONOSTA_scene_dimensional_stack extension allows for multiple scenes in one file in a manner similar
...
| time_manifold | string | The name of the time manifold. | "@E1" |
...
* `@Sol3` refers to Sol3
* `@Sol4_1` refers to Sol4_1
* `@Sol4_0` refers to Sol4_1
* `@Sol4_M_N` where M and N are replaced with integers refers to Sol4_{M,N}
* `@Sol5_M_N_P` where M, N, and P are replaced with integers refers to Sol5_{M,N,P}
